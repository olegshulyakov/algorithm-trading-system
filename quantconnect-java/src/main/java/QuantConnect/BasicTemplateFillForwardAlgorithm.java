 ...
 */
public class BasicTemplateFillForwardAlgorithm extends QCAlgorithm {
    /**
    ...
    public void Initialize() {
        ...
        AddSecurity(SecurityType.wrap(SecurityType.Equity), "ASUR", Resolution.wrap(Resolution.Second), true, false);
    }
    ...
    public void OnData(Slice data) {
        if (!get_Portfolio().get_Invested()) {
            SetHoldings(Symbol("ASUR"), 1, false);
